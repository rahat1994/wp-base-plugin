...
<template>
    <div
        class="hidden flex-col space-y-4 py-2 sm:flex md:order-2 bg-blue-200 p-4 shadow-md"
    >
                ...
                <AccordionContent>
                    <div class="flex items-center space-x-2 mb-4 px-2">
                        <Switch
                            ...
                            @update:checked="
                                ($event) =>
                                    editorTitleStateUpdated($event, 'show')
                            "
                        />
                    ...
                    <div class="my-4 px-2 py-2">
                        <Select
                            ...
                            @update:modelValue="
                                ($event) =>
                                    editorTitleStateUpdated($event, 'tag')
                            "
                        >
                            <SelectTrigger>
                    ...
                    <div class="my-4 px-2">
                        <Input
                            ...
                            @update:modelValue="
                                ($event) =>
                                    editorTitleStateUpdated($event, 'classes')
                            "
                        />
                    </div>
                </AccordionContent>
        ...
        <Accordion type="single" collapsible>
            <AccordionItem value="item-2" open>
                ...
                <AccordionContent>
                    ...
                    <Label class="px-2">HTML tag for the description</Label>
                    <div class="px-2 py-2">
                        <Select
                            :default-value="state.config.description.tag"
                            @update:modelValue="
                                ($event) =>
                                    editorDescriptionStateUpdated($event, 'tag')
                            "
                        >
                            <SelectTrigger>
                                <SelectValue placeholder="HTML Tag" />
                        ...
                        <br />
                        <Input
                            :default-value="state.config.description.classes"
                            @update:modelValue="
                                ($event) =>
                                    editorDescriptionStateUpdated(
                                        $event,
                ...
                <AccordionContent>
                    ...
                    <div class="my-4 px-2">
                        <Select
                            ...
                            @update:modelValue="
                                ($event) =>
                                    editorListStateUpdated($event, 'tag')
                            "
                        >
                            <SelectTrigger>
