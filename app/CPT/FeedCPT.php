...
class FeedCPT implements CPTInterface
{
    ...
    {
        add_action('init', array($this, 'registerFeedPostType'));
        add_action('add_meta_boxes', array($this, 'add_meta_box'));
        add_action('save_post', array($this, 'save'));
        add_filter('manage_subreddit_feed_posts_columns', array($this, 'addShortCodeColumn'));
        add_action('manage_subreddit_feed_posts_custom_column', array($this, 'productCustomColumnValues'), 10, 2);
    }
    ...
    public function productCustomColumnValues($column, $post_id)
    {
        $post_id = (int) $post_id;
    ...
    public function registerFeedPostType()
    {
        register_post_type(
            'subreddit_feed',
            array(
